...
def render_landing_page():
    """Renders the landing page with single-line Navbar, Hero, About, Features, How It Works, Tech Stack, About Project, and Footer."""
    ...
    # -------------------------------------------------------------------------
    st.markdown("""<div class="landing-navbar-container"><div class="nav-brand">AI Risk Forecasting</div><div class="nav-links-row"><a href="#hero" class="nav-btn" target="_self">Home</a><a href="#features" class="nav-btn" target="_self">Features</a><a href="#how-it-works" class="nav-btn" target="_self">How It Works</a><a href="#about" class="nav-btn" target="_self">About</a><a href="?page=auth&mode=login" class="nav-btn" target="_self">Login</a><a href="?page=auth&mode=register" class="nav-btn" target="_self">Get Started</a></div></div>""", unsafe_allow_html=True)

    # -------------------------------------------------------------------------
    # 2. HERO CARD
    # -------------------------------------------------------------------------
    st.markdown("""<div class="advanced-hero-card" id="hero"><span class="hero-pill-animated">Intelligent Predictive Risk Analytics</span><h1 class="hero-title-gradient">AI-Based Project Risk Forecasting System</h1><div class="hero-subtitle-bold">Predict Project Risks Before They Become Problems</div><p class="hero-desc-lead">An intelligent machine learning platform that analyzes project data, forecasts potential risks, and helps teams make proactive decisions for successful project delivery.</p></div>""", unsafe_allow_html=True)
    ...
    # -------------------------------------------------------------------------
    # 4. SECTION 1: FEATURES (TYPE 1 CARDS)
    # -------------------------------------------------------------------------
    st.markdown("""<div class="section-wrapper" id="features"><div class="section-header"><div class="section-tag">Key Features</div><h2 class="section-title">Intelligent Risk Forecasting</h2><p class="section-desc">Use machine learning to analyze project information and forecast potential project risks.</p></div><div class="features-grid-3col"><div class="type1-feature-card"><div class="type1-card-accent"></div><div class="type1-title">Early Risk Identification</div><div class="type1-desc">Identify potential risks before they become critical and affect project progress.</div></div><div class="type1-feature-card"><div class="type1-card-accent"></div><div class="type1-title">Risk Analysis</div><div class="type1-desc">Understand the project factors that contribute to different levels of risk.</div></div><div class="type1-feature-card"><div class="type1-card-accent"></div><div class="type1-title">Data-Driven Insights</div><div class="type1-desc">Turn project data into meaningful insights that support better decision-making.</div></div><div class="type1-feature-card"><div class="type1-card-accent"></div><div class="type1-title">Project Monitoring</div><div class="type1-desc">Keep track of project information and risk prediction results in one place.</div></div><div class="type1-feature-card"><div class="type1-card-accent"></div><div class="type1-title">Prediction History</div><div class="type1-desc">Review previous risk predictions to understand project risk patterns over time.</div></div><div class="type1-feature-card"><div class="type1-card-accent"></div><div class="type1-title">Intelligent Risk Forecasting</div><div class="type1-desc">Use machine learning to analyze project information and forecast potential project risks.</div></div></div></div>""", unsafe_allow_html=True)

    # -------------------------------------------------------------------------
    # 5. SECTION 2: HOW IT WORKS (TYPE 2 CARDS)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # 6. SECTION 3: TECHNOLOGY STACK (TYPE 3 CARDS)
    # -------------------------------------------------------------------------
    ...
    # 8. FOOTER SECTION
    # -------------------------------------------------------------------------
    st.markdown("""<div class="landing-footer"><div class="footer-brand">AI-Based Project Risk Forecasting System</div><div class="footer-tagline">Predict risks. Plan better. Deliver successfully.</div><div class="footer-copyright">© 2026 AI-Based Project Risk Forecasting System</div></div>""", unsafe_allow_html=True)
